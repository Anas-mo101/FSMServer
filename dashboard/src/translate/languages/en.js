const messages = {
  en: {
    translations: {
      ...
      quickAnswersModal: {
        title: {
          add: "Add Automated Flow",
          edit: "Edit Automated Flow",
        },
        form: {
          shortcut: "Name",
          message: "Automated Flow",
        },
        buttons: {
          okAdd: "Add",
          okEdit: "Save",
        ...
        success: "Automated Flow saved successfully.",
      },
      queueModal: {
        title: {
          add: "Add queue",
      ...
      quickAnswers: {
        ...
        toasts: {
          deleted: "Automated flow deleted successfully.",
        },
        searchPlaceholder: "Search...",
        confirmationModal: {
          deleteTitle: "Are you sure you want to delete this Automated flow: ",

...
abstract class FlutterFlowTheme {
  static Future initialize() async => _prefs = await AppPreferences.getTheme();

  static ThemeMode get themeMode {
    final darkMode = _prefs;
    return darkMode == null ? ThemeMode.system : ( darkMode ? ThemeMode.dark : ThemeMode.light );
  }

  static void saveThemeMode(ThemeMode mode) => mode == ThemeMode.system ? AppPreferences.storeTheme(false) : AppPreferences.storeTheme(mode == ThemeMode.dark);
